...
with and inserted before the last item. Your function should be able to work with any list value passed to it. Be sure to test the case where an empty list [] is 
